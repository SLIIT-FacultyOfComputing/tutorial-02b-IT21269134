...
int main(){
  float cm,inches;//declaring variables
  
  cout<<"Enter a length in cm :"<<endl;//getting user input
  cin>>cm;
  
  inches=cm/2.54;//calculating
  
  cout<<"Length in inches is :"<<inches<<endl;//display the output
